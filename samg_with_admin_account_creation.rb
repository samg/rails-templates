...
# Install all gems
  ...
  gem 'thoughtbot-factory_girl',
    ...
    :version => '>= 1.2.1'
  inside('vendor/plugins'){run "git clone git://github.com/samg/clearance.git" }
  inside('vendor/plugins/clearance') do
    run <<-BASH
      git branch --track with_admin_account_creation origin/with_admin_account_creation
      git checkout with_admin_account_creation
      rm -rf .git
    BASH
  end
